{
  ...
  age.secrets.ts-rpi3b-nixos.file = ../../secrets/ts-rpi3b-nixos.age;
  ...
  systemd.services.tailscale-autoconnect = {
    ...
    script = with pkgs; ''
      ...
      ${tailscale}/bin/tailscale up --authkey=$(cat ${config.age.secrets.ts-rpi3b-nixos.path}) --advertise-exit-node --ssh
    '';
  };
